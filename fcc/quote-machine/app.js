...
var quotes = [
    ...
    "Maana often has the most tickets.",
    ...
    "Public code review forces one to better oneself. It forces better practices, smarter solutions, growth as a developer... or being broken. -----proverbs[]:Testing covers not testing.",
...
function getQuote() {
    ...
    $("#quote").html('"' + quote + '"');
    $("#twitter-button").attr("href", encodeURI(tweetText + quote));
}
